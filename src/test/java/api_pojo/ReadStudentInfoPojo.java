...
public class ReadStudentInfoPojo extends ArrayList<ReadStudentInfoPojo> {
    ...
    public ReadStudentInfoPojo(){

    }

    public ReadStudentInfoPojo(int id, double midtermExam, double finalExam, int absentee, String infoNote, String lessonName, int creditScore, String educationTerm, double average, StudentResponsePojo studentResponse, boolean compulsory, String note) {
        this.id = id;
