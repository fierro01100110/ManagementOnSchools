...
Feature: Deans should be able to create a Vice Dean account.
  ...
  Scenario Outline: US06_GetViceDeanByUsername
    ...
    Then my body should contain by orhan name "<name>", surname "<surname>",birth_place "<birth_place>",gender "<gender>",birth_day "<birth_day>",phone_number "<phone_number>",ssn "<ssn>",username "<username>"
